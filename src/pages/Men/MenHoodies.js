...
import img4 from "../pagesimage/vnmufc-00297-058,1.jpg";
import img5 from "../pagesimage/vnmufc-00297-058,2.jpg";
import img6 from "../pagesimage/vnmufc-00297-058,3.jpg";
import img7 from "../pagesimage/vnmufc-00298-004,1.jpg";
import img8 from "../pagesimage/vnmufc-00298-004,2.jpg";
import img9 from "../pagesimage/vnmufc-00298-004,3.jpg";
import img10 from "../pagesimage/vnmufc-00298-058,1.jpg";
import img11 from "../pagesimage/vnmufc-00298-058,2.jpg";
import img12 from "../pagesimage/vnmufc-00298-058,3.jpg";
import "../../styles/pageCommon.css";

const products = [
  { id: 1, title: "Название товара 1", desc: "Описание товара 1", price: 1200, oldPrice: 1800, season: "", images: [img1, img2, img3], discount: true },
  { id: 2, title: "Название товара 2", desc: "Описание товара 2", price: 0, oldPrice: 0, season: "", images: [img4, img5, img6], discount: false },
  { id: 3, title: "Название товара 3", desc: "Описание товара 3", price: 0, oldPrice: 0, season: "", images: [img1, img2, img3], discount: false },
  { id: 4, title: "Название товара 4", desc: "Описание товара 4", price: 0, oldPrice: 0, season: "", images: [img1, img2, img3], discount: false },
...
export default function MenHoodies() {
  ...
  const getUserPhone = () => localStorage.getItem("phone") || "test";
  ...
  const handleAddToCart = (productId) => {
    ...
    fetch(`${API_URL}/cart`, {
      ...
      body: JSON.stringify({ phone, product_id: productId, quantity: 1 })
    })
      .then(res => res.json())
      .then(data => {
        if (data.success) {
            ...
            <div className="product-card" key={product.id}>
              ...
              <div className="product-card-body">
                ...
                <div className="product-card-bottom">
                  ...
                  <button className="product-card-btn" onClick={() => handleAddToCart(product.id)}>В корзину</button>
                </div>
              </div>
            </div>
          ))
